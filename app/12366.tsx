...
export default function HomePage() {
  return (
    <div className="space-y-12 pb-16 min-h-screen bg-gray-50 text-gray-800 dark:bg-zinc-950 dark:text-gray-100 font-sans">
      
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-b from-emerald-600 to-emerald-700 dark:from-emerald-900/80 dark:to-zinc-900 text-white py-16 px-4 sm:px-6 lg:px-8 rounded-b-3xl shadow-lg">
        <div className="max-w-4xl mx-auto text-center space-y-6 relative z-10">
          <span className="inline-block px-3.5 py-1 bg-emerald-500/30 border border-emerald-400/30 rounded-full text-xs font-semibold tracking-wide text-emerald-100 uppercase">
