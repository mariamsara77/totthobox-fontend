...
function ResetPasswordForm() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      // কুকি ইতিমধ্যে সেট হয়ে গেছে (auto-login) — পুরো পেজ রিলোড করলে
      // AuthContext নতুন কুকি দেখে user fetch করে নেবে, /login এ পাঠানোর দরকার নেই
  ...
  return (
    <div className="space-y-4">
      <div className="text-center space-y-2">
        <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-blue-500/10 text-blue-600 mb-1">
          <KeyRound size={24} />
        </div>
...
export default function ResetPasswordPage() {
  return (
    <Suspense
      fallback={
        <div className="text-center py-10 opacity-50">লোড হচ্ছে...</div>
      }
    >
      <ResetPasswordForm />
    </Suspense>
