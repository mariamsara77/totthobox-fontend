...
export default function LoginPage() {
  ...
  // রিডাইরেক্ট পাথ (যদি কোনো প্রোটেক্টেড পেজ থেকে রিডাইরেক্ট হয়ে এসে থাকে)
 const redirectTo = "/";
  ...
  // ইউজার আগেই লগইন করা থাকলে অটো-রিডাইরেক্ট করবে
  useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // লগইন সফল হলে পেজ রিফ্রেশ না করে রিডাইরেক্ট হবে
  ...
  if (isAuthLoading) return null; // বা লোডার দেখাতে পারেন
