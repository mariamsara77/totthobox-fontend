    ...
    <div className="max-w-2xl mx-auto space-y-6 p-4 sm:p-6">
      ...
      <header className="flex items-start justify-between gap-4">
        ...
        <div className="relative shrink-0">
          ...
          {showCreators && (
            <div className="absolute right-0 top-full mt-2 w-80 max-h-96 overflow-y-auto rounded-2xl border border-zinc-400/25 bg-white dark:bg-zinc-900 shadow-xl p-4 z-50 space-y-3">
              <div>
              ...
              {creators.length === 0 ? (
                ...
                creators.map((c) => (
                  <div
                    key={c.id}
                    className="flex items-start gap-3 p-2 rounded-xl hover:bg-zinc-50 dark:hover:bg-zinc-800"
                  >
      ...
      <div className="flex items-center gap-3">
        ...
        {search && (
          <button
            onClick={() => setSearch("")}
            className="p-2.5 rounded-xl border border-zinc-400/25 text-zinc-500 hover:bg-zinc-50 dark:hover:bg-zinc-800"
          >
            <X className="w-5 h-5" />
          </button>
        )}
          ...
          Object.entries(grouped).map(([category, items]) => (
            <div key={category} className="space-y-4">
              <div className="flex justify-center">
                <span className="px-4 py-1 rounded-full bg-zinc-800 text-white dark:bg-zinc-200 dark:text-zinc-900 text-xs font-bold uppercase tracking-widest">
                  {category}
                </span>
              </div>
      ...
      <section className="space-y-4 pt-6 border-t border-zinc-400/25">
        ...
        <div className="space-y-3 text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
          <p>
            ...
            এখানে দেশের ভৌগোলিক অবস্থান, প্রশাসনিক বিভাগ, জনসংখ্যা, সংস্কৃতি, অর্থনীতি এবং
            অন্যান্য গুরুত্বপূর্ণ তথ্য একত্রিত করা হয়েছে।
          </p>
          <p>
            “বিস্তারিত পড়ুন” বাটনে ক্লিক করে পুরো ব্যাখ্যা, পরিসংখ্যান এবং প্রাসঙ্গিক তথ্য
            জানতে পারবেন। সার্চ ব্যবহার করে সহজেই প্রয়োজনীয় তথ্য খুঁজে নিতে পারবেন।
          </p>
        </div>
      </section>
    </div>
