...
export default function NumberToWordConverter() {
  ...
  return (
    <main className="max-w-2xl mx-auto space-y-4 p-4">
      ...
      {/* Reference Table */}
      <section>
        <div className="bg-zinc-400/25  rounded-xl overflow-hidden ">
          <button
          ...
          >
            ...
            <ChevronDown
              className={`size-4  transition ${refOpen ? "rotate-180" : ""}`}
            />
          </button>

          {refOpen && (
            <div className="border-t border-zinc-400/25 overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-zinc-400/25">
                  {[
                    ...
                    [
                      "১০.৭৫",
                      "দশ টাকা ও পঁচাত্তর পয়সা",
                      "Ten Taka and Seventy-Five Paisa",
                    ],
                    ["১০০", "এক শত টাকা", "One Hundred Taka"],
                    [
                      "১,০০০.৫০",
                      "এক হাজার টাকা ও পঞ্চাশ পয়সা",
