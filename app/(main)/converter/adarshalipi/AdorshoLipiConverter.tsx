...
function convertToAdarshalipi(sample: string): string {
  ...
  for (var i = 0; i < outputText.length; i++) {
    if (
      outputText[i] == "্" &&
      (outputText[i + 1] == "ে" || outputText[i + 1] == "ি")
    ) {
      i3 += outputText[i];
      i3 += outputText[i + 2];
      i3 += outputText[i + 1];
  ...
  return (
    <main className="max-w-2xl mx-auto p-4 space-y-4">
      <header className="text-center space-y-2">
        ...
        <p>রিয়েল-টাইম উভয়মুখী বাংলা লিপি রূপান্তর</p>
      </header>
        ...
        <article className="bg-zinc-400/10 rounded-xl p-4 space-y-4">
          ...
          <div className="flex justify-end">
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 hover:bg-zinc-400/25  bg-zinc-400/10 rounded-lg transition"
            >
        ...
        <article className="bg-zinc-400/10 rounded-xl p-4 space-y-4">
          ...
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2   bg-zinc-400/10 rounded-lg hover:bg-zinc-400/25 transition"
            >
              <Clipboard className="size-4" />
              {copyTextU}
            </button>
      ...
      <section className="">
        <h2 className="text-lg ">আদর্শলিপি ও ইউনিকোড কনভার্টার সম্পর্কে</h2>
        <div className=" leading-relaxed space-y-4">
          <p>
            <strong>আদর্শলিপি</strong> একটি ANSI ভিত্তিক বাংলা ফন্ট সিস্টেম যা
            দীর্ঘদিন ধরে প্রিন্টিং, অফিস ডকুমেন্ট এবং পুরনো সফটওয়্যারে ব্যবহৃত
            হয়ে আসছে। অন্যদিকে <strong>ইউনিকোড</strong> আধুনিক ওয়েব
            স্ট্যান্ডার্ড, যা সব ব্রাউজার ও ডিভাইসে সঠিকভাবে দেখায়।
          </p>
          <p>
            এই টুলটি <strong>উভয়মুখী রিয়েল-টাইম কনভার্সন</strong> সাপোর্ট করে।
            আপনি ইউনিকোড লিখলে স্বয়ংক্রিয়ভাবে আদর্শলিপিতে রূপান্তর হবে, আবার
            আদর্শলিপি লিখলে ইউনিকোডে চলে আসবে।
          </p>
        </div>
      </section>
    </main>
