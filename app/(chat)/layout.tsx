...
export default function ChatLayout({ children }: { children: React.ReactNode }) {
  return (
    <div
      className={`${bengali.variable} chat-layout-root h-[calc(100dvh-4rem)] min-h-0 w-full overflow-hidden overscroll-none bg-zinc-50 text-zinc-950 bg-zinc-400/10 dark:text-zinc-50`}
    >
      <ChatLayoutProvider>
