  ...
  return (
    <div className="max-w-2xl mx-auto space-y-12 py-6">
      ...
      <section className="space-y-4">
        <div>
          <h2 className="text-xl ">প্ল্যাটফর্ম স্ট্যাটিস্টিক্স</h2>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="p-4 rounded-xl bg-zinc-400/10">
          ...
          <p className="leading-relaxed">
            দৈনন্দিন জীবনের প্রয়োজনীয় সব ডিজিটাল টুলস, নির্ভরযোগ্য তথ্য এবং
            শিক্ষামূলক কনটেন্ট সহজে ও বিনামূল্যে সবার হাতের মুঠোয় পৌঁছে দেওয়া।
        ...
        <div className="p-4 rounded-xl bg-zinc-400/10">
          ...
          <p className="leading-relaxed">
            বাংলাদেশের সবচেয়ে নির্ভরযোগ্য এবং স্বয়ংসম্পূর্ণ ডিজিটাল প্ল্যাটফর্ম
            হিসেবে নিজেদের প্রতিষ্ঠিত করা — যেখানে শিশু থেকে বৃদ্ধ, সবার
            দৈনন্দিন জিজ্ঞাসার সমাধান এবং প্রয়োজনীয় ডিজিটাল টুলস থাকবে।
          </p>
        </div>
      </section>
      ...
      <section className="space-y-5">
        <div className="text-center space-y-2">
          ...
          <p className="">আমরা যা অফার করি</p>
        </div>
      ...
      <section className="space-y-4">
        <div className="text-center space-y-2">
          ...
          <p className="">এক নজরে Totthobox-এর মূল ফিচারগুলো</p>
        </div>
      ...
      <div className="p-8 text-center space-y-4">
        <div className="space-y-2">
          <h3 className="text-lg ">আমাদের সাথে যুক্ত হোন</h3>
          <p>
