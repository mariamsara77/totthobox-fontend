    ...
    <div className="max-w-2xl mx-auto space-y-12 p-4">
      ...
      <section className="space-y-4">
        <div>
          <h2 className="text-xl font-bold">
            প্ল্যাটফর্ম স্ট্যাটিস্টিক্স
          </h2>
          <p className="text-sm">
            লাইভ ইউজার ড্যাশবোর্ড
          </p>
        </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="p-6 rounded-xl border">
          ...
          <p className="leading-relaxed text-sm">
            বাংলাদেশের সবচেয়ে নির্ভরযোগ্য এবং স্বয়ংসম্পূর্ণ ডিজিটাল প্ল্যাটফর্ম
            হিসেবে নিজেদের প্রতিষ্ঠিত করা — যেখানে শিশু থেকে বৃদ্ধ, সবার
            দৈনন্দিন জিজ্ঞাসার সমাধান এবং প্রয়োজনীয় ডিজিটাল টুলস থাকবে।
          </p>
        </div>
      </section>
