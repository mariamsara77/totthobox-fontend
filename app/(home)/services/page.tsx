  ...
  return (
    <div className="mx-auto max-w-2xl space-y-4 p-4">
      <header className="space-y-2 border-b border-zinc-400/25 pb-4">
        <h1 className="text-2xl font-bold">মূল সেবা</h1>
      ...
      <section className="space-y-4" aria-labelledby="services-heading">
        <h2 id="services-heading" className="text-xl font-bold">সকল সেবা</h2>
        ...
        <div className="space-y-4 text-sm leading-relaxed">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>বাংলা ক্যালেন্ডার ও ছুটির তালিকা — বাংলা ও ইংরেজি তারিখ, সরকারি ছুটি এবং বিশেষ দিবস।</li>
              <li>জরুরি সেবা ও হেল্পলাইন — পুলিশ, ফায়ার সার্ভিস, অ্যাম্বুলেন্সসহ প্রয়োজনীয় নম্বর।</li>
              <li>ইসলামিক শিক্ষা — নামাজের নিয়ম, কালেমা, দোয়া এবং মৌলিক ইসলামিক জ্ঞান।</li>
              <li>কনভার্টার ও টুলস — মুদ্রা রূপান্তর, সংখ্যা থেকে শব্দ, ছবি রিসাইজ এবং অন্যান্য টুলস।</li>
              <li>বিশ্বকোষ — দেশ-বিদেশের মৌলিক তথ্য, পতাকা, রাজধানী ও মুদ্রার তথ্য।</li>
              <li>স্বাস্থ্য ও সংকেত — সাধারণ স্বাস্থ্য এবং ট্রাফিক সংকেত সম্পর্কিত তথ্য।</li>
            </ul>
          </div>
          <p className="opacity-50">
            আমরা বিশ্বাস করি প্রযুক্তি সহজ ও সবার জন্য ব্যবহারযোগ্য হওয়া উচিত। তাই Totthobox-এ পরিষ্কার নেভিগেশন এবং দ্রুত লোডিংয়ের উপর গুরুত্ব দেওয়া হয়।
          </p>
        </div>
      </article>
    </div>
