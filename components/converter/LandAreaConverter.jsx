      ...
      <div className="space-y-8">
        ...
        <div className="space-y-4 w-full">
          ...
          <div className="w-full flex flex-col gap-2">
            ...
            <div className="flex w-full rounded-lg overflow-hidden border border-zinc-400/25">
              <select
                value={inputUnit}
                onChange={(e) => setInputUnit(e.target.value)}
                className="w-full sm:w-1/2 p-2 bg-zinc-800 border-none cursor-pointer outline-none text-zinc-50 text-zinc-100"
              >
              ...
              <input
                ...
                className="w-full sm:w-1/2 p-2 bg-zinc-800/80 outline-none text-zinc-50 text-zinc-100"
              />
            </div>
          </div>
