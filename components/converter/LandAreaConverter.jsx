      ...
      <div className="space-y-8">
        ...
        <div className="space-y-4 w-full">
          ...
          <div className="w-full flex flex-col gap-2">
            ...
            <div className="flex w-full rounded-xl overflow-hidden border border-zinc-400/25">
              <select
                value={inputUnit}
                onChange={(e) => setInputUnit(e.target.value)}
                className="w-full sm:w-1/2 p-2 bg-zinc-400/10 border-none cursor-pointer outline-none text-zinc-50 text-zinc-100"
              >
              ...
              <input
                ...
                className="w-full sm:w-1/2 p-2 bg-zinc-400/10 outline-none text-zinc-50 text-zinc-100"
              />
            </div>
          </div>
        ...
        <div className="mt-16 pt-10 border-t border-zinc-400/25 space-y-4 text-sm ">
          ...
          <div>
            <h3 className="text-lg font-bold text-zinc-50 text-zinc-200 mb-4">গুরুত্বপূর্ণ কনভার্শন (বাংলাদেশ স্ট্যান্ডার্ড)</h3>
            <ul className="list-disc list-inside space-y-2 ml-1">
