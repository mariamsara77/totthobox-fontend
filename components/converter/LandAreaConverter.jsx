...
<div className="space-y-5">
  ...
  <div className="flex justify-center py-1">
    <button onClick={swapLandUnits} title="ইউনিট অদলবদল করুন" className="rounded-full p-3 transition-colors hover:bg-zinc-400/25 active:scale-95">
