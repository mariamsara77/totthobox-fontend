...
type Unit = keyof typeof areaConversionRates;
...
export default function AreaConverter() {
  ...
  const [inputUnit, setInputUnit] = useState<Unit>("square_meter");
  const [outputUnit, setOutputUnit] = useState<Unit>("square_foot");
