    ...
    <div className="space-y-8">
      ...
      <header className="text-center space-y-3">
        ...
        <p className="text-sm text-zinc-600 dark:text-zinc-400">
          মিটার, কিলোমিটার, মাইল, ফুট, ইঞ্চি ও আরও
        </p>
      </header>
...
<div className="space-y-5">
  ...
  <div className="space-y-2">
    ...
    <div className="flex">
      <select
        ...
        className="w-[42%] appearance-none rounded-l-xl rounded-r-none bg-zinc-400/10 px-3 py-3.5 outline-none border-r border-zinc-400/20 hover:bg-zinc-400/20 transition text-sm"
      >
      ...
      <input
        ...
        className="w-[58%] rounded-r-xl rounded-l-none bg-zinc-400/10 px-3 py-3.5 outline-none hover:bg-zinc-400/20 transition"
      />
    </div>
  </div>
  ...
  <div className="flex justify-center py-1">
    <button onClick={swapLengthUnits} title="ইউনিট অদলবদল করুন" className="rounded-full p-3 transition-colors hover:bg-zinc-400/25 active:scale-95">
  ...
  <div className="space-y-2">
    ...
    <div className="flex">
      ...
      <input
        ...
        readOnly
        placeholder="ফলাফল"
        className="w-[58%] rounded-r-xl rounded-l-none bg-zinc-400/10 px-3 py-3.5 outline-none cursor-default"
      />
    </div>
  </div>
</div>
