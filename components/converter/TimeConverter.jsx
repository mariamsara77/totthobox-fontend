    ...
    <div className="space-y-8">
      ...
      <header className="text-center space-y-3">
        ...
        <p className="text-sm text-zinc-600 dark:text-zinc-400">
          সেকেন্ড, মিনিট, ঘণ্টা, দিন, সপ্তাহ ও আরও
        </p>
      </header>
...
<div className="space-y-5">
  ...
  <div className="flex justify-center py-1">
    <button onClick={swapTimeUnits} title="ইউনিট অদলবদল করুন" className="rounded-full p-3 transition-colors hover:bg-zinc-400/25 active:scale-95">
