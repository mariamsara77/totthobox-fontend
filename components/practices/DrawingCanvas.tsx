...
const DrawingCanvas = forwardRef<DrawingCanvasHandle, Props>(
  function DrawingCanvas(
    ...
    return (
      // return এর ভিতরে container div-এর className পরিবর্তন করুন:
      <div
        ref={containerRef}
        className="relative rounded-2xl overflow-hidden bg-zinc-100 dark:bg-zinc-800 border border-zinc-400/20"
      >
        <canvas
          ref={canvasRef}
